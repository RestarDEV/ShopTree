...
class _AddInfoShopState extends State<AddInfoShop> {
      ...
      child: RaisedButton.icon(
        ...
        onPressed: () {
          if (nameShop == null ||
              ...
              phone == null ||
              phone.isEmpty) {
            normalDialog(context, 'กรุณากรอกช่องว่าง');
          } else if (file == null) {
  ...
  Future<Null> uploadImage() async {
    ...
    String url = '${MyConstant().domain}/treeshop/saveShop.php';
    ...
    try {
      ...
      await Dio().post(url, data: formData).then((value) {
        ...
        urlImage = '/treeshop/Shop/$nameImage';
  ...
  Future<Null> editUserShop() async {
    ...
    String url =
        '${MyConstant().domain}/treeshop/editUserWhereld.php?isAdd=true&id=$id&NameShop=$nameShop&Address=$address&Phone=$phone&UrlPicture=$urlImage&Lat=$lat&Lng=$lng';

    await Dio().get(url).then((value) {
      if (value.toString() == 'true') {
        Navigator.pop(context);
      } else {
        normalDialog(context, 'กรุณาลองใหม่ไม่สามารถบันทึกได้');
      }
    });
  }
